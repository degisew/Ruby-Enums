...
```sh
  cd Ruby-Enums
  git clone https://github.com/degisew/Ruby-Enums.git
```
...
- LinkedIn: [NurkaAmre](https://www.linkedin.com/in/amre-nurgul/)
...
Feel free to check the [issues page](https://github.com/degisew/Ruby-Enums/issues).
...
This project is [MIT](https://github.com/degisew/Ruby-Enums/blob/dev/LICENSE) licensed.
